...
static NSString * const LYHTTPClientURLString = kPubServer;
//static NSString * const LYHTTPClientRequestCache = @"LYHTTPClientRequestCache";
static NSString * const LYHTTPClientRequestCache = @"LYHTTPClientReturnCacheDataDontLoad";
...
+ (NSURLSessionDataTask *)requestMethod:(LYHTTPClientRequestType)type
                            ...
                            cachePolicy:(LYHTTPClientRequestCachePolicy)cachePolicy
                                success:(void (^)(NSURLSessionDataTask *task, id responseObject))success
                      failure:(void (^)(NSURLSessionDataTask *task, NSError *error))failure{
    NSString *cacheKey = [self getCacheKey:URLString param:parameters];
    if (parameters) {
...
+ (NSString *)getCacheKey:(NSString *)urlString param:(NSDictionary *)param {
    return [self urlDictToStringWithUrlStr:urlString WithDict:param];
...
+ (NSURLSessionDataTask *)requestMethod:(LYHTTPClientRequestType)type
    ...
    switch (type) {
        case LYHTTPClientRequestTypeGET:{
            return [[LYHTTPClient sharedClient] GET:URLString parameters:parameters
        ...
        case LYHTTPClientRequestTypePOST:{
            return [[LYHTTPClient sharedClient] POST:URLString parameters:parameters progress:^(NSProgress * _Nonnull uploadProgress) {
...
//   return [[LYHTTPClient alloc] initWithBaseURL:[NSURL URLWithString:LYHTTPClientURLString] sessionConfiguration:configuration];
    return [[LYHTTPClient alloc] initWithSessionConfiguration:configuration];
}
@end
