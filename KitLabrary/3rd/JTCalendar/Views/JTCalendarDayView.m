...
//        _circleView.backgroundColor = [UIColor colorWithRed:0x33/256. green:0xB3/256. blue:0xEC/256. alpha:.5];
        _circleView.backgroundColor = [UIColor colorWithRed:0.91 green:0.44 blue:0.40 alpha:1.00];
...
//    _dotView.center = CGPointMake(self.frame.size.width / 5., self.frame.size.height / 5.);
